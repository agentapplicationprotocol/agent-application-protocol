...
head:
  - - meta
    - name: description
      content: 兼容 Agent Application Protocol (AAP) 的 Agent 目录，包括 AAP Agent Hub 和 TypeScript 示例 Agent。
  - - meta
    - property: og:title
      content: Agent — Agent Application Protocol
  - - meta
    - property: og:description
      content: 兼容 Agent Application Protocol (AAP) 的 Agent 目录，包括 AAP Agent Hub 和 TypeScript 示例 Agent。
  - - meta
    - property: og:url
      content: https://agentapplicationprotocol.com/zh/agents
  - - meta
    - name: twitter:title
      content: Agent — Agent Application Protocol
  - - meta
